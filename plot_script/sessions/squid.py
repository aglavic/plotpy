...
from plot_script.measurement_data_structure import PhysicalConstant
# importing preferences and data readout
from plot_script.read_data import squid as read_data
from plot_script.config import squid as config
from plot_script.config import diamagnetism_table
...
'''
  ...
  def __init__(self, arguments):
    ...
    '''
    self.COLUMNS_MAPPING=config.COLUMNS_MAPPING
    self.MEASUREMENT_TYPES=config.MEASUREMENT_TYPES
  ...
  def add_file(self, filename, append=True):
    ...
    for dataset in datasets:
      ...
      # name the dataset
      constant, unit=dataset.unit_trans_one(dataset.type(), config.TRANSFORMATIONS_CONST)
