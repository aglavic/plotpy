...
gnuplot_file_name=globals.temp_dir+'gnuplot.tmp'
...
set_output_terminal_png='png enhanced size 1600,1200 font "/usr/share/fonts/truetype/msttcorefonts/arial.ttf" 26' #transparent
set_output_terminal_ps='postscript landscape enhanced colour "Arial" 24'
...
# parameters for the coure
plotting_parameters='w lines lw 4' # plotting x-y
plotting_parameters_errorbars='w errorlines pt 5 ps 2 lw 4' # plotting with errorbars
plotting_parameters_3d='w pm3d' # plotting 3d
plotting_parameters_fit='w lines lw 5'
