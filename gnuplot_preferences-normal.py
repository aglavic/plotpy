...
gnuplot_file_name='/var/tmp/gnuplot.tmp'
...
set_output_terminal_png='png enhanced size 1600,1200 font "/usr/share/fonts/truetype/msttcorefonts/arial.ttf" 18' #transparent
set_output_terminal_ps='postscript landscape enhanced colour "Arial" 14'
...
plotting_parameters='w linespoints pt 5 ps 1 lw 2' # plotting x-y
plotting_parameters_errorbars='w errorlines pt 5 ps 0.5 lw 2' # plotting with errorbars
