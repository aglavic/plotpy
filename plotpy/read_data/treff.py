...
from plotpy.mds import MeasurementData, PhysicalProperty, PhysicalConstant
from plotpy.config.treff import GRAD_TO_MRAD, GRAD_TO_RAD, D17_PIXEL_SIZE, D17_CENTER_OFFSET
...
def read_data(file_name, script_path, import_images, return_detector_images):
  ...
  from plotpy.config.treff import DETECTOR_ROWS_MAP, DETECTOR_PIXELS, PIXEL_WIDTH, CENTER_PIXEL, CENTER_PIXEL_Y, DETECTOR_REGION, PI_4_OVER_LAMBDA #@UnusedImport
...
def read_data_maria(file_name, script_path, import_images, return_detector_images):
  ...
  from plotpy.config.maria import DETECTOR_ROWS_MAP, COLUMNS_MAPPING, DETECTOR_PIXELS, PIXEL_WIDTH, CENTER_PIXEL, CENTER_PIXEL_Y, DETECTOR_REGION #@UnusedImport
...
from plotpy.config.treff import D17_MASK#, D17_CALIBRATION_FILES

def read_d17_raw_data(file_from, file_to):
  '''
    Read d17 raw detector images.
  '''
  from plotpy.config import treff
  treff.LAMBDA_N=5.3
  PI_2_OVER_LAMBDA=numpy.pi*2./5.3
